...
declare namespace Safetify {
    ...
    function Boolean(): Resolver<boolean>;
    type Boolean = Resolver<boolean>;

    function Number(): Resolver<number>;
    type Number = Resolver<number>;

    function String(): Resolver<string>;
    type String = Resolver<string>;

    type Any = Resolver<any>;
    function Any(): Resolver<any>;

    function BooleanResolver(): Resolver<boolean>;
    type BooleanResolver = Resolver<boolean>;

    function NumberResolver(): Resolver<number>;
    type NumberResolver = Resolver<number>;

    function StringResolver(): Resolver<string>;
    type StringResolver = Resolver<string>;

    type AnyResolver = Resolver<any>;
    function AnyResolver(): Resolver<any>;
